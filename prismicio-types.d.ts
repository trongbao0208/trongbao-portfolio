...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Button Resume Text field in *Hero → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.primary.button_resume_text
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  button_resume_text: prismic.KeyTextField;

  /**
   * Button Resume Link field in *Hero → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.primary.button_resume_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  button_resume_link: prismic.LinkField;
}
